  ...
  useEffect(() => {
    const getData = async () => {
      const { data } = await axios.get(
        ...
        }/newalljobs?page=${currentPage}&size=${itemsPerPage}&filter=${filter}&sort=${sort}`,
    ...
    getData();
  }, [itemsPerPage, sort, filter, currentPage, pages]);
  useEffect(() => {
      ...
      <div className="flex justify-center mt-12">
        ...
        {pages.map((btnNum) => (
          <button
            ...
            key={btnNum}
            className={`hidden ${
              currentPage === btnNum ? "bg-green-300" : ""
